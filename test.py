...
if (selected == "Parkinsons Prediction"):
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_prediction = parkinsons_model.predict([[PPE,spread1,fo,spread2 ,APQ, flo,  Jitter_Abs,fhi,HNR,NHR,Jitter_percent ,APQ5,APQ3,DDA,Shimmer_dB,PPQ,RAP,Shimmer]])                          
